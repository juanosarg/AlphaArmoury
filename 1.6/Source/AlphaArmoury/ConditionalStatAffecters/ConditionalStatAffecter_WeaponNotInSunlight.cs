...
{
    public class ConditionalStatAffecter_WeaponNotInSunlight : ConditionalStatAffecter
    {
        public override string Label => "AArmoury_StatsReport_NotInSunlight".Translate();
