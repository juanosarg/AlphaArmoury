...
{
    public const int ticksLifetime = 120;
    ...
    protected override void Tick()
    {
        ...
        if (sustainer == null || sustainer.Ended)
            sustainer = InternalDefOf.AArmoury_Cryo_Sustainer.TrySpawnSustainer(SoundInfo.InMap(this, MaintenanceType.PerTick));
        sustainer.Maintain();
        tickCounter++;
        if(tickCounter>= ticksLifetime)
        {
            Destroy();
            return;
        }
