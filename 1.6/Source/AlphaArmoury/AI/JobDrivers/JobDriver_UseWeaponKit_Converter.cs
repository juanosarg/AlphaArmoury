...
{
    public class JobDriver_UseWeaponKit_Converter : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            {
                WeaponConversionKit kit = this.pawn.CurJob.targetA.Thing as WeaponConversionKit;
                if (kit != null) {
                    CompUseEffect_WeaponKit_Converter comp = this.pawn.CurJob.targetA.Thing.TryGetComp<CompUseEffect_WeaponKit_Converter>();
                    comp.weapon = kit.weapon;
                    comp.DoEffectOn(this.pawn, job.targetB.Thing);
                }
