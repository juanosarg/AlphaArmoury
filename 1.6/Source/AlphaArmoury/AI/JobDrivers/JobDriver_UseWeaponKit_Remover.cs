...
{
    public class JobDriver_UseWeaponKit_Remover : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            {
                CompUseEffect_WeaponKit_Remover comp = this.pawn.CurJob.targetA.Thing.TryGetComp<CompUseEffect_WeaponKit_Remover>();
